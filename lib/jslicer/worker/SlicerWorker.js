...
self.importScripts('/lib/jslicer/core/StlReader.js');
self.importScripts('/lib/jslicer/core/ClipperPath.js');
self.importScripts('/lib/jslicer/core/Infill.js');
self.importScripts('/lib/jslicer/core/MeshSlicer.js');
self.importScripts('/lib/jslicer/core/SlicerEngine.js');

self.importScripts('/lib/jslicer/worker/GeometrySerialize.js');
